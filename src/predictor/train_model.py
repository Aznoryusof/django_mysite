...
from src.predictor.prepare_data import prepare_data
from src.predictor.model import model_NN
...
def save_accuracy(eval_model, file_name, timestr):
    ...
    file_name_final = BASE_DIR + "/results/model_val_accuracy/" + file_name
...
def main():
    data = pd.read_csv("data/raw/bankloan.csv")
